...
public class BeatBox {
    ...
    private static final int MAX_SOUNDS = 5; //# of concurrent sounds
    private static final float PLAYBACK_DEFAULT = 1.0f;
    ...
    public BeatBox(Context context){
        ...
        loadSounds();
        mPlayBackRate = PLAYBACK_DEFAULT;
    }

    public void play(Sound sound){
        Integer soundId = sound.getSoundId();
        //check if sound was loaded correctly
        if(soundId == null){
            return;
        }
    ...
    public void setPlayBackRate(int rate){
        mPlayBackRate = MIN_PLAYBACK_RATE + (PLAYBACK_DEFAULT * (rate/100));
    }
}
